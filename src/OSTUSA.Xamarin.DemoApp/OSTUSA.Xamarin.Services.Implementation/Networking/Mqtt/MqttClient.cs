...
using OSTUSA.XamarinDemo.Core.Networking.Mqtt.Utility;
using OSTUSA.XamarinDemo.Core.Networking.Mqtt.Session;
using OSTUSA.XamarinDemo.Core.Networking.Mqtt.Exceptions;
using OSTUSA.XamarinDemo.Core.Networking.Mqtt.Events;
using OSTUSA.XamarinDemo.Services.Networking.Mqtt.Messages;
using OSTUSA.XamarinDemo.Services.Networking.Mqtt.Internal;
...
namespace OSTUSA.XamarinDemo.Services.Networking.Mqtt
{
    ...
    {
        public MqttClient(string url, int brokerPort, IWebSocketConnection webSocketConnection)
        {
            bool isSecure = url.StartsWith("wss") || url.StartsWith("https://");

            MqttSslProtocols protocol = MqttSslProtocols.TLSv1_2;
            _webSocketConnection = webSocketConnection;

           
            Init(url, brokerPort, isSecure, protocol);
        }
...
//#endif
            ...
            this._inflightQueue = new Queue();

            // queue for received message
            this._receiveEventWaitHandle = new AutoResetEvent(false);
            this._eventQueue = new Queue();
            this._internalQueue = new Queue();

            this._channel = new MqttNetworkChannel(_brokerHostName, _brokerPort, secure, sslProtocol, _webSocketConnection);

            // session
            this.session = null;

            //  TODO:  Implement this
            //this._channel = new MqttNetworkChannel(this._brokerHostName, this._brokerPort, secure, sslProtocol);
...
//#endif
        ...
        {
            if (_webSocketConnection != null && _webSocketConnection.IsOpen)
            {
        ...
        private void Close()
        {
            ...
            this._keepAliveEvent.Set();

            if (this._keepAliveEventEnd != null)
                this._keepAliveEventEnd.WaitOne();
        ...
        {
#if TRACE
            System.Diagnostics.Debug.WriteLine(string.Format("SEND {0}", msg));
        ...
        private bool EnqueueInflight(MqttMsgBase msg, MqttMsgFlow flow)
        {
                ...
                (msg.QosLevel == MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE))
            {
                lock (this._inflightQueue)
                {
                    ...
                    MqttMsgContext msgCtx = (MqttMsgContext)this._inflightQueue.Get(msgCtxFinder.Find);
        ...
        private void ReceiveThread()
        {
            ...
            while (this.isRunning)
            {
                try
                {
                    ...
                    readBytes = this._channel.Receive(fixedHeaderFirstByte, ref this.isRunning);
                    ...
                    if (readBytes > 0)
                    {
                        ...
                        switch (msgType)
                        {
                            ...
                            case MqttMsgBase.MQTT_MSG_CONNACK_TYPE:
                                ...
                                _msgReceived = MqttMsgConnack.Parse(fixedHeaderFirstByte[0], (byte)ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                            ...
                            case MqttMsgBase.MQTT_MSG_PINGRESP_TYPE:
                                ...
                                this._msgReceived = MqttMsgPingResp.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                                MqttUtility.Trace.WriteLine(TraceLevel.Frame, "RECV {0}", this.msgReceived);
#endif
                                this._syncEndReceiving.Set();
                            ...
                            case MqttMsgBase.MQTT_MSG_SUBACK_TYPE:
                                ...
                                MqttMsgSuback suback = MqttMsgSuback.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBLISH_TYPE:
                                ...
                                MqttMsgPublish publish = MqttMsgPublish.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBACK_TYPE:
                                ...
                                MqttMsgPuback puback = MqttMsgPuback.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBREC_TYPE:
                                ...
                                MqttMsgPubrec pubrec = MqttMsgPubrec.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBREL_TYPE:
                                ...
                                MqttMsgPubrel pubrel = MqttMsgPubrel.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                            ...
                            case MqttMsgBase.MQTT_MSG_PUBCOMP_TYPE:
                                ...
                                MqttMsgPubcomp pubcomp = MqttMsgPubcomp.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
                            ...
                            case MqttMsgBase.MQTT_MSG_UNSUBACK_TYPE:
                                ...
                                MqttMsgUnsuback unsuback = MqttMsgUnsuback.Parse(fixedHeaderFirstByte[0], (byte)this.ProtocolVersion, this._channel, ref this.isRunning);
#if TRACE
