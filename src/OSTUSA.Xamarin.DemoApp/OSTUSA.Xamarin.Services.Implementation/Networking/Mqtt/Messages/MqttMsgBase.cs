...
using System;
using System.Text;
using OSTUSA.XamarinDemo.Services.Networking.Mqtt;
...
namespace OSTUSA.XamarinDemo.Services.Networking.Mqtt.Messages
{
    ...
    public abstract class MqttMsgBase
    {
        ...
        protected static int decodeRemainingLength(IMqttNetworkChannel channel, ref bool isRunning)
        {
            int multiplier = 1;
            int value = 0;
            int digit = 0;
            ...
            do
            {
                ...
                channel.Receive(nextByte, ref isRunning);
                digit = nextByte[0];
