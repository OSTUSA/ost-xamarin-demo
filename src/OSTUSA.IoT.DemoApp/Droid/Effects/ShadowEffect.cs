...
[assembly: ExportEffect(typeof(OSTUSA.IoT.DemoApp.Droid.Effects.ShadowEffect), "ShadowEffect")]
    ...
    public class ShadowEffect : PlatformEffect
    {
        protected override void OnAttached()
        {
            try
            {
                ...
                //var effect = (OSTUSA.IoT.DemoApp.Effects.ShadowEffect)Element.Effects.FirstOrDefault(e => e is OSTUSA.IoT.DemoApp.Effects.ShadowEffect);
                //if (effect != null)
                //{
